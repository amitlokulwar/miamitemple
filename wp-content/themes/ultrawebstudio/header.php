...
<p class="right_share">Share <img src="<?php bloginfo('template_url'); ?>/images/icons/social/facebook.png"> <img src="<?php bloginfo('template_url'); ?>/images/icons/social/twitter.png"></p>
